					...
					A3(
						...
						F2(
							function (item, _n0) {
								var acc = _n0.a;
								var seed = _n0.b;
								var _n1 = A2(elm$random$Random$step, elm_community$random_extra$Random$List$anyInt, seed);
								var tag = _n1.a;
								var nextSeed = _n1.b;
								return _Utils_Tuple2(
									A2(
...
var author$project$Main$expand = function (_n0) {
	var xs = _n0.a;
	var dst = _n0.b;
	var perms = A2(
		elm$core$List$map,
...
var author$project$Main$dist = F2(
	function (src, dest) {
		var f = function (q) {
			f:
			while (true) {
				var _n0 = turboMaCk$queue$Queue$dequeue(q);
				if (_n0.a.$ === 'Just') {
					var _n1 = _n0.a.a;
					var cur = _n1.a;
					var d = _n1.b;
		...
		if (!_n0.b.b) {
			...
			if (!_n0.a.b) {
				...
				if (x) {
					...
					var _n3 = A2(author$project$Main$partition, xs, ys);
					if (_n3.b) {
						var z = _n3.a;
						var zs = _n3.b;
						return A2(
				...
				case 'GotViewport':
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								height: elm$core$Maybe$Just(vp.viewport.height),
								width: elm$core$Maybe$Just(vp.viewport.width)
							}),
						elm$core$Platform$Cmd$none);
				default:
					var w = msg.a;
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								...
								width: elm$core$Maybe$Just(w)
							}),
						elm$core$Platform$Cmd$none);
			}
		}
	});
var author$project$Main$ClickLine = function (a) {
	return {$: 'ClickLine', a: a};
};
var author$project$Main$EnterLine = function (a) {
	return {$: 'EnterLine', a: a};
};
var author$project$Main$EnterPolygon = function (a) {
	return {$: 'EnterPolygon', a: a};
};
var author$project$Main$LeaveLine = function (a) {
	return {$: 'LeaveLine', a: a};
};
...
var author$project$Main$modelToCollage = function (model) {
	...
	var lineWithSpace = F2(
		function (i, c) {
			...
			var line = A2(
				...
				A3(timjs$elm_collage$Collage$roundedRectangle, 6, 70, 3));
			return A2(
					...
					A2(
						...
						A2(
							...
							A2(
								...
								A3(timjs$elm_collage$Collage$roundedRectangle, 30, 94, 15))))));
		});
	var lines = A3(
		elm$core$List$map2,
		lineWithSpace,
	...
	var counters = timjs$elm_collage$Collage$Layout$horizontal(
		_List_fromArray(
			[
	...
	return A2(
		...
		A2(timjs$elm_collage$Collage$Layout$align, timjs$elm_collage$Collage$Layout$topLeft, game));
};
...
var author$project$Main$view = function (model) {
	var _n0 = _Utils_Tuple2(model.width, model.height);
	if (_n0.a.$ === 'Nothing') {
		var _n1 = _n0.a;
		...
		if (_n0.b.$ === 'Nothing') {
			...
			var collageWidth = timjs$elm_collage$Collage$Layout$width(gameCollage);
			var collageHeight = timjs$elm_collage$Collage$Layout$height(gameCollage);
			var k = A2(elm$core$Basics$min, w / collageWidth, h / collageHeight);
			var scaledGameCollage = A2(timjs$elm_collage$Collage$scale, k, gameCollage);
			var gameSvg = timjs$elm_collage$Collage$Render$svg(scaledGameCollage);
